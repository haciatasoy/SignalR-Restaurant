...
namespace SignalRWebApi.Hubs
{
	public class SignalRHub:Hub
	{
        ...
        public async Task SendProgress()
        {
            ...
            var value9 = _productService.TTotalPriceByTatli();
        ...
        public async Task SendNotification()
        {
            ...
            var value2 = _messageService.TNotificationCountByFalse();
            await Clients.All.SendAsync("ReceiveMessageCountByFalse", value2);

            var messageListByFalse = _messageService.TGetAllMessagesByFalse();
        ...
        {
            var value = _orderService.OrderListWithMenuTable();
            await Clients.All.SendAsync("ReceiveOrderListWithMenuTable", value);
        }
	}
}

...
namespace SignalRWebUI.Controllers
{
    public class SocialMediaController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateSocialMedia(CreateSocialDto createSocialMediaDto)
        {
            var client = _httpClientFactory.CreateClient();
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateSocialMedia(UpdateSocialDto updateSocialMediaDto)
        {
            var client = _httpClientFactory.CreateClient();
